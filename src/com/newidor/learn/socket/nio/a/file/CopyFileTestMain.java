package com.newidor.learn.socket.nio.a.file;
...
public class CopyFileTestMain {
	...
	public static void copyFileByStreamTest() throws IOException {
		FileUtils.copyFile("E:/Project/JavaAPIDemo/tmp/a/a.zip", "E:/Project/JavaAPIDemo/tmp/a/a2.zip");
	}
	
	public static void copyFileByDirectByteBuffer() throws IOException {
		ByteBuffer byteBuffer = ByteBuffer.allocateDirect(1024 * 1024);
		FileUtils.copyFileByByteBuffer("E:/Project/JavaAPIDemo/tmp/a/a.zip", "E:/Project/JavaAPIDemo/tmp/a/a2.zip", byteBuffer, false);
	}
	...
	public static void copyFileByMappedByteBuffer() throws IOException {
		FileUtils.copyFileByMappedByteBuffer("E:/Project/JavaAPIDemo/tmp/a/a.zip", "E:/Project/JavaAPIDemo/tmp/a/a2.zip");
	}
