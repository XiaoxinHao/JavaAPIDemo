package com.newidor.learn.socket.a;
...
import com.newidor.learn.socket.a.client.component.CharsetByteRelative;
import com.newidor.learn.socket.a.client.sender.BFileSender;
import com.newidor.learn.socket.a.client.sender.DefaultSender;
import com.newidor.learn.socket.a.client.sender.FileSender;
import com.newidor.learn.socket.a.client.sender.GetFileSender;
import com.newidor.learn.socket.a.client.sender.MessageSender;
...
public class Commons {
	...
	public final static String SERVER_SAVE_BASE_PATH = "tmp/javaA/upload/";
